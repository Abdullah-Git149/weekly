            ...
            <section className="dashboardWrap">
                ...
                <div className="mainContent">
                    ...
                    <div className="contentBody">
                        <h1 className="headingMain pt-3">Add Generator</h1>
                                    ...
                                    <form action className="addCustomerForm">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <select name id className="inputItem" required>
                                                ...
                                                <option value>Generac</option>
                                                <option value>Kohler</option>
                                                <option value>Briggs & Stratton</option>
                                                <option value>GE</option>
                                                <option value>Others</option>
                                            </select>
                                        </div>
                                        <div className="form-group">
                                            <label>Generator Type* <span>:</span></label>
                                            <select name id className="inputItem" required>
                                                <option value disabled selected>Select</option>
                                        ...
                                        <div className="form-group">
                                            <label>Generator Size (in KW)* <span>:</span></label>
                                            <input type="number" className="inputItem" placeholder="Enter Generator Serial Number" required />
                                        </div>
                                        <div className="form-group">
                                            ...
                                            <select name id className="inputItem" required>
                                                ...
                                                <option value>Liquid Propane</option>
                                        ...
                                        <div className="form-group">
                                            <label>Generator Image<span>:</span></label>
                                            <input type="file" className="inputTypeFile inputItem" />
                                        </div>
                                        <div className="form-group">
...
export default AddNewGenerator