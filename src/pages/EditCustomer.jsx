                            ...
                            <div className="col-12">
                                <div className="genBox type-2">
                                    ...
                                    <form action className="addCustomerForm">
                                        ...
                                        <div className="form-group">
                                            <label>Catogory* <span>:</span></label>
                                            <select name id className="inputItem" required>
                                                <option value disabled selected>Select</option>
                                                <option value>Active</option>
                                                <option value>Inactive</option>
                                                <option value>Repair Only</option>
                                                <option value>Estimated Sold</option>
                                                <option value>Estimated Undecided</option>
                                                <option value>Estimated Lost</option>
